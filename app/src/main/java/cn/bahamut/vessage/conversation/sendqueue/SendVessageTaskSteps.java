...
public class SendVessageTaskSteps {
    ...
    public static final String[] SEND_FILE_VESSAGE_STEPS = new String[]{PostVessageHandler.HANDLER_NAME, SendAliOSSFileHandler.HANDLER_NAME, FinishFileVessageHandler.HANDLER_NAME};
}
